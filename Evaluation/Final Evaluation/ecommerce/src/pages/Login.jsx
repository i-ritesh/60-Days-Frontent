...
import { useToast , Button, Heading, Input, VStack, Container  } from "@chakra-ui/react";
  ...
  return (
    <>
      ...
      <VStack spacing={6}>
        ...
        />
        <Button variant="outline" colorScheme="teal" onClick={handleLoginChange}>Login In</Button>
      </VStack>
      </Container>
    </>
  );
